<div id="events" class="events">
    <div class="container">
        <h3 class="w3_agileits_head">Sobre <span class="w3_child">G</span><span class="w3_child1">K</span><span
                    class="w3_child2">i</span><span class="w3_child3">n</span><span class="w3_child4">d</span><span
                    class="w3_child1">e</span><span class="w3_child2">r</span></h3>
        <p class="w3_agile_elit">Algunos datos sobre nosotros.</p>
        <br><br>
        ...
        <h4>Comunicación directa con nuestro centro de ayuda las 24 horas del día, nos concentramos en la experiencia
            del usuario.</h4>
        <h4>¿Tenés un centro infantil? Hacé más fácil la comunicación. Todo en tiempo real y fácil de usar, lo que se
            ahorras de tiempo se puede dedicar a lo más importantes, los niños.</h4>
